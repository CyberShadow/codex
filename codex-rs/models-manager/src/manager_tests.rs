...
fn openai_manager_for_tests(
    ...
    ModelsManager::new_openai_with_endpoint_client(
        codex_home,
        endpoint_client,
...
fn static_manager_for_tests(model_catalog: ModelsResponse) -> ModelsManager {
    ModelsManager::new_static(
        /*auth_mode*/ None,
        model_catalog,
        CollaborationModesConfig::default(),
    )
...
fn build_available_models_picks_default_after_hiding_hidden_models() {
    ...
    let available = manager.build_available_models_for_test(vec![hidden_model, visible_model]);
